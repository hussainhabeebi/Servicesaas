    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f9fafb" }}>
      <form onSubmit={handleSubmit} style={{ background: "#fff", padding: "2.5rem", borderRadius: 16, width: "100%", maxWidth: 360, boxShadow: "0 8px 24px rgba(0,0,0,0.06)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.6rem", marginBottom: "1.5rem" }}>
          ...
          <h1 style={{ fontSize: "1.3rem", margin: 0 }}>ServBazaar</h1>
        </div>
        ...
        <button type="submit" disabled={loading} style={{ width: "100%", marginTop: "1.5rem", padding: "0.8rem", background: "#036f71", color: "#fff", border: "none", borderRadius: 8, fontWeight: 700, cursor: "pointer" }}>
